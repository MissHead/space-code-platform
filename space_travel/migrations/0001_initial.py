...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Ship',
            fields=[
                ('pilot_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='space_travel.pilot')),
                ('fuel_capacity', models.IntegerField()),
                ('fuel_level', models.IntegerField()),
                ('weight_capacity', models.IntegerField()),
            ],
            bases=('space_travel.pilot',),
        ),
    ]
